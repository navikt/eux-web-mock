...
module.exports.lesSchemaSync = (schemapath) => Utils.readJsonAndParseSync(schemapath);

module.exports.lesSchemaASync = (schemapath) => Utils.readJsonAndParseSync(schemapath);
...
const lesSchemaDefinitonsSync = () => Utils.readJsonAndParseSync(DEFINITION_SCHEMA);
module.exports.lesSchemaDefinitonsSync = lesSchemaDefinitonsSync;

const humanReadableErrors = (allErrors = []) => allErrors.map((singleError) => {
  const {
